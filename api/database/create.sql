...
START TRANSACTION;
USE `portal_aluno`;
INSERT INTO `portal_aluno`.`professor` (`id`, `nome`, `email`, `foto`, `formatoImagem`) VALUES (1, 'ISABELA CRISTINA CASSIANO', 'isabela@gmail.com', '', 'image/jpg;base64');
INSERT INTO `portal_aluno`.`professor` (`id`, `nome`, `email`, `foto`, `formatoImagem`) VALUES (2, 'CAROLINA MENEZES DA COSTA', 'carolina@terra.com.br', '', 'image/jpg;base64');
INSERT INTO `portal_aluno`.`professor` (`id`, `nome`, `email`, `foto`, `formatoImagem`) VALUES (3, 'CAIO BATISTA CABRAL', 'caiocabral@hotmail.com.br', '', 'image/png;base64');
INSERT INTO `portal_aluno`.`professor` (`id`, `nome`, `email`, `foto`, `formatoImagem`) VALUES (4, 'VINICIUS RODRIGUES FEITOZA VILLACA', 'vinicius@hotmail.com', '', 'image/png;base64');
INSERT INTO `portal_aluno`.`professor` (`id`, `nome`, `email`, `foto`, `formatoImagem`) VALUES (5, 'GEILDA CAMPOS ALVARIO MARQUEZ', 'geilda33@gmail.com', '', 'image/png;base64');
